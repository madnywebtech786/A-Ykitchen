        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16 border-b border-gray-800">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="tel:+14039669190" className="flex items-start gap-3 text-gray-400 hover:text-primary transition-colors group">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">403 966 9190</p>
                  </div>
                </a>
              </li>
              <li>
