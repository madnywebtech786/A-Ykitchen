  ...
  return (
    <section id="about" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-1/3 left-1/3 w-40 h-40 bg-gradient-to-tr from-primary/6 to-transparent rounded-full blur-2xl animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-2/3 right-1/3 w-36 h-36 bg-gradient-to-br from-primary/5 to-transparent rounded-full blur-xl animate-float"
        ...
        <div
          className="absolute top-1/2 left-1/4 w-28 h-28 border border-primary/8 rounded-2xl rotate-12 animate-float"
        ...
        {/* Triangular Shapes */}
        <div
          className="absolute top-1/3 right-1/3 w-20 h-20 bg-primary/3 rotate-45 animate-float"
          style={{ animationDelay: "3s" }}
        ></div>
        <div
          className="absolute top-1/2 left-16 w-16 h-16 border-2 border-primary/7 rotate-[30deg] animate-float"
        ...
        {/* Lines and Paths */}
        <svg
          className="absolute top-1/3 right-1/4 w-40 h-40 opacity-10"
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              At A&Y Kitchen Cabinets, we've been crafting high-quality
              cabinetry since 2010. We specialize in Canadian-inspired designs
              that blend natural woods like maple and oak with modern finishes.
            </p>

            <p className="text-gray-600 leading-relaxed">
              Our team of expert designers and craftsmen is dedicated to
              delivering personalized solutions that reflect your unique style
              and needs. With a commitment to sustainability, we source
              materials responsibly and prioritize eco-friendly practices in
              every project.
            </p>
