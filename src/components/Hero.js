        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left space-y-8 animate-slide-in-left">
            ...
            <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-2xl">
              Premium Canadian-inspired cabinetry blending natural woods with modern finishes.
              Personalized designs crafted with sustainability and excellence at heart.
            </p>
          ...
          <div className="relative animate-slide-in-right">
            <div className="relative z-10">
              ...
              <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-primary-light rounded-2xl opacity-20 animate-float z-0" style={{ animationDelay: '1s' }}></div>
            </div>

            {/* Floating Card */}
            <div className="absolute -bottom-8 -left-8 bg-white rounded-2xl shadow-2xl p-6 animate-float hidden lg:block z-20" style={{ animationDelay: '3s' }}>
